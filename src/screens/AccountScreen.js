    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileHeaderContainer}>
        ...
        <View style={styles.profileTextContainer}>
          <Text style={styles.nameText}>Malakhov Nikita</Text>
          <Text style={styles.emailText}>nikita.malakhov022@gmail.com</Text>
        </View>
      </View>
      <View style={styles.menuContainer}>
        ...
        <TouchableOpacity style={styles.menuItem} activeOpacity={0.8}>
          <View style={{ ...styles.menuIcon, backgroundColor: Colors.LIGHT_RED }}>
            <MaterialCommunityIcons name="gift-outline" size={18} color={Colors.SECONDARY_RED} />
          </View>
          <Text style={styles.menuText}>Offers {'&\n'} Promos</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem} activeOpacity={0.8}>
          <View style={{ ...styles.menuIcon, backgroundColor: Colors.LIGHT_YELLOW }}>
            <Ionicons name="location-outline" size={18} color={Colors.DEFAULT_YELLOW} />
          </View>
      ...
      <View style={styles.mainContainer}>
        ...
        <TouchableOpacity style={styles.sectionContainer} activeOpacity={0.8}>
          ...
          <Feather name="chevron-right" color={Colors.INACTIVE_GREY} size={20} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.sectionContainer} activeOpacity={0.8}>
          <View style={styles.sectionTextContainer}>
