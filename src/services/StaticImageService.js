...
const getLogo = (imageId) => `${ApiContants.STATIC_IMAGE.BASE_URL}/logo/${imageId}.png`;
...
const getGalleryImage = (imageId, size, quality = ApiContants.STATIC_IMAGE.QUALITY.SD) =>
